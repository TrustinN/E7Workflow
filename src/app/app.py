...
class App(QApplication):
    ...
    def _initLayout(self):
        ...
        self.layoutRight.addWidget(self.wksBtn)
        self.layoutRight.addWidget(self.setE1Btn)
        self.layoutRight.addWidget(self.setE2Btn)
        self.layoutRight.addWidget(self.createEdgeBtn)
        self.layoutRight.addWidget(self.entryBtn)
        self.layoutRight.addWidget(self.executeBtn)
        self.layoutRight.addWidget(self.exportBtn)
        self.layoutRight.addWidget(self.importBtn)
